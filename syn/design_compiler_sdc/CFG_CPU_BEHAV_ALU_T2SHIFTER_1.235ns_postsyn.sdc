...
# Created by write_sdc on Wed Oct 26 21:07:56 2022
...
create_clock [get_ports CLK]  -period 1.235  -waveform {0 0.6175}
set_max_delay 1.235  -from [list [get_ports CLK] [get_ports RST_AN] [get_ports {IMEM_DOUT[31]}]    \
