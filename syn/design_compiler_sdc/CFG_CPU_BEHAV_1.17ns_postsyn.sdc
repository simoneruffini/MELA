...
# Created by write_sdc on Thu Oct 27 17:04:11 2022
...
create_clock [get_ports CLK]  -period 1.17  -waveform {0 0.585}
set_max_delay 1.17  -from [list [get_ports CLK] [get_ports RST_AN] [get_ports {IMEM_DOUT[31]}]    \
