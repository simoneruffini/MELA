...
# Created by write_sdc on Wed Oct 26 20:53:16 2022
...
create_clock [get_ports CLK]  -period 1.05  -waveform {0 0.525}
set_max_delay 1.05  -from [list [get_ports CLK] [get_ports RST_AN] [get_ports {IMEM_DOUT[31]}]    \
