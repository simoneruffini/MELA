...
# Created by write_sdc on Wed Oct 26 21:45:38 2022
...
create_clock [get_ports CLK]  -period 1.49  -waveform {0 0.745}
set_max_delay 1.49  -from [list [get_ports CLK] [get_ports RST_AN] [get_ports {IMEM_DOUT[31]}]    \
