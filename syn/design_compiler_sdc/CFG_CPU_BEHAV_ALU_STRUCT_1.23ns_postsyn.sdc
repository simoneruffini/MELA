...
# Created by write_sdc on Thu Oct 27 17:37:11 2022
...
create_clock [get_ports CLK]  -period 1.23  -waveform {0 0.615}
set_max_delay 1.23  -from [list [get_ports CLK] [get_ports RST_AN] [get_ports {IMEM_DOUT[31]}]    \
