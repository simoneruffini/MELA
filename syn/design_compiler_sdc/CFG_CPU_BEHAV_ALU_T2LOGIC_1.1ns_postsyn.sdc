...
# Created by write_sdc on Wed Oct 26 20:47:11 2022
...
create_clock [get_ports CLK]  -period 1.1  -waveform {0 0.55}
set_max_delay 1.1  -from [list [get_ports CLK] [get_ports RST_AN] [get_ports {IMEM_DOUT[31]}]    \
