...
# Created by write_sdc on Wed Oct 26 21:47:10 2022
...
create_clock [get_ports CLK]  -period 1.45  -waveform {0 0.725}
set_max_delay 1.45  -from [list [get_ports CLK] [get_ports RST_AN] [get_ports {IMEM_DOUT[31]}]    \
