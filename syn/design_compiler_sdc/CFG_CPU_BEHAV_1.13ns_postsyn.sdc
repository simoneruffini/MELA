...
# Created by write_sdc on Thu Oct 27 17:19:38 2022
...
create_clock [get_ports CLK]  -period 1.13  -waveform {0 0.565}
set_max_delay 1.13  -from [list [get_ports CLK] [get_ports RST_AN] [get_ports {IMEM_DOUT[31]}]    \
