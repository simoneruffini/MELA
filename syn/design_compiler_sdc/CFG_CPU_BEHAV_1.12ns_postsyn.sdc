...
# Created by write_sdc on Wed Oct 26 18:11:14 2022
...
create_clock [get_ports CLK]  -period 1.12  -waveform {0 0.56}
set_max_delay 1.12  -from [list [get_ports CLK] [get_ports RST_AN] [get_ports {IMEM_DOUT[31]}]    \
